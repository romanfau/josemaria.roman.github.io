...
\newcommand{\version}{Madrid, 5 diciembre 2020.}
...
{\small C/ Santa Engracia 108, 3$^o$ dcha.}
   & {\small {\bf Tel:}} & {\small +34\,91\,529\,6007} \\
{\small E-28003 Madrid, Espa\~na}
...
\item Gesti\'on del equipo t\'ecnico.
\item Optimizaci\'on de modelos f{\'\i}sicos aplicados a componentes magn\'eticos para equipos el\'ectricos y electr\'onicos.
\item Modelizaci\'on del dise\~no de componentes magn\'eticos mediante Inteligencia Artificial.
\end{itemize}
...
%\begin{itemize}\itemsep 0pt
%\item 
Dieciseis presentaciones orales y dos posters invitados en varias 
...
%\begin{itemize}\itemsep 0pt
%\item 
Asistencia a veinti\'un cursos y conferencias internacionales.
%\end{itemize}
...
%\begin{itemize}\itemsep 0pt
%\item 
Ocho proyectos de investigación dirigidos en Energ{\'\i}a Solar Fotovoltaica.
%\end{itemize}
...
\item Conocimiento de Auto-CAD, HTML (http://dftuz.unizar.es/ftzar/mapoftheweb.html, Java, JSON y XML.
...
{\it cicNetwork Ciencia y Tecnología} {\bf n$^o$ 11} (mayo 2012) 36-42.
...
Workshop INVIVONexth on O\&M and Acceptance for PV plants in arid climates.
CIEMAT, Madrid, Spain.
Dec.~14, 2017.
...
%\setcounter{enumi}{11}
\item
{\it El bos\'on de Higgs: la simetría y la masa}. 
...
\item
INVIVONexth on O\&M and Acceptance for PV plants in arid climates.
CIEMAT, Madrid, Spain.
Dec.~14, 2017. 
...
Student: Mois\'es O\~noro Salaíces. 
%(12-0032-DEV)
